...
$arr = [
    'id' => intval($toMember['id']),
    'account_id' => intval($toMember['id']), // create a new array for this member
    'to_name' => $toMember['forename'] . ' ' . $toMember['surname'],
    'from_id' => intval($toMember['id']),
    'family_id' => intval($toMember['id']),
    'to_family_id' => intval($toMember['id']),
    'allow' => 1,
];
$stack = $data['families'];
