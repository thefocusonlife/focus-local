...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {              // If form submitted
    ...
    if ($invalid) {                                      // If data is not valid
        ...
        if (empty($recaptchaToken)) {
            ...
            $errors['message'] = 'Security check token missing. Please refresh the page and try again.';
        } else {
            ...
            if (!verify_recaptcha_v3($recaptchaToken, 'login', $secretKey, 0.1)) {
                ...
                elseif ($member && $member['role'] == 'suspended') {    // If member is suspended
                ...
                */
                ...
                elseif ($member && $member['role'] == 'pending') {      // If member is pending
...
// Session/website context for navigation, same as before
if ($_SESSION['id'] == 2) {
    $member = 0;
